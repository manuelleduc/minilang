/**
 */
package fr.inria.diverse.minilang.melange.minilanglanguagemt.minilang.impl;

import fr.inria.diverse.minilang.melange.minilanglanguagemt.minilang.BinaryOperation;
...
public class MinilangPackageImpl extends EPackageImpl implements MinilangPackage {
	 ...
	 * @see fr.inria.diverse.minilang.melange.minilanglanguagemt.minilang.MinilangPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(programEClass, null, "mainK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(methodEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(blockEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(ifStmtEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(statementEClass, Statement.class, "Statement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(statementEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(conditionEClass, Condition.class, "Condition", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(conditionEClass, ecorePackage.getEBoolean(), "evalK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(greaterThanEClass, ecorePackage.getEBoolean(), "evalK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(valueEClass, Value.class, "Value", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(valueEClass, ecorePackage.getEDouble(), "valueK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(constantEClass, ecorePackage.getEDouble(), "valueK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(variableRefEClass, ecorePackage.getEDouble(), "valueK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(variableAffectEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(sumEClass, Sum.class, "Sum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(sumEClass, ecorePackage.getEDouble(), "valueK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(moduloEClass, Modulo.class, "Modulo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(moduloEClass, ecorePackage.getEDouble(), "valueK3", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(callMethodEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(moveEClass, Move.class, "Move", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(moveEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(rotateRightEClass, RotateRight.class, "RotateRight", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(rotateRightEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(rotateLeftEClass, RotateLeft.class, "RotateLeft", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(rotateLeftEClass, null, "executeK3", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (ifStmtEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (greaterThanEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (variableAffectEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (sumEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (moduloEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (callMethodEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (rotateRightEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (rotateLeftEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });
	}
