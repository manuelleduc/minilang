...
public class MinilangSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MinilangPackage.CONDITION: {
			...
			case MinilangPackage.GREATER_THAN: {
				...
				if (result == null) result = caseCondition(greaterThan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.VALUE: {
			...
			case MinilangPackage.VARIABLE_REF: {
				...
				if (result == null) result = caseValue(variableRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.VARIABLE_AFFECT: {
				VariableAffect variableAffect = (VariableAffect)theEObject;
				T result = caseVariableAffect(variableAffect);
				if (result == null) result = caseStatement(variableAffect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.SUM: {
				...
				if (result == null) result = caseValue(sum);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.MODULO: {
				...
				if (result == null) result = caseBinaryOperation(modulo);
				if (result == null) result = caseValue(modulo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.BINARY_OPERATION: {
			...
			case MinilangPackage.CALL_METHOD: {
				...
				if (result == null) result = caseStatement(callMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case MinilangPackage.ROTATE_RIGHT: {
				...
				if (result == null) result = caseStatement(rotateRight);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MinilangPackage.ROTATE_LEFT: {
				...
				if (result == null) result = caseStatement(rotateLeft);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Variable Affect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Variable Affect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVariableAffect(VariableAffect object) {
		return null;
	}
