...
/**
 * This is the item provider adapter for a {@link minilang.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_program_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_program_feature", "_UI_Method_type"),
				 MinilangPackage.Literals.METHOD__PROGRAM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MinilangPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MinilangPackage.Literals.METHOD__BLOCK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Method.class)) {
			case MinilangPackage.METHOD__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MinilangPackage.METHOD__BLOCK:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MinilangPackage.Literals.METHOD__BLOCK,
				 MinilangFactory.eINSTANCE.createBlock()));
	}
