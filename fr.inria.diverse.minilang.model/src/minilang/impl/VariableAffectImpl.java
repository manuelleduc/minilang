 ...
 * </p>
 * <ul>
 * <li>{@link minilang.impl.VariableAffectImpl#getVariable <em>Variable</em>}
 * </li>
...
public class VariableAffectImpl extends StatementImpl implements VariableAffect {
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MinilangPackage.VARIABLE_AFFECT__VARIABLE,
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinilangPackage.VARIABLE_AFFECT__VARIABLE,
					oldVariable, variable));
	}
	...
	public NotificationChain basicSetValue(Value newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MinilangPackage.VARIABLE_AFFECT__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MinilangPackage.VARIABLE_AFFECT__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MinilangPackage.VARIABLE_AFFECT__VALUE, newValue,
					newValue));
	}
