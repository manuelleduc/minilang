 ...
 * </p>
 * <ul>
 *   <li>{@link minilang.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link minilang.impl.VariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable {
	...
	public void setValue(double newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinilangPackage.VARIABLE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinilangPackage.VARIABLE__NAME:
				return getName();
			case MinilangPackage.VARIABLE__VALUE:
				return getValue();
		}
